...
export function RiskScanToolLoop() {
  ...
  return (
    <Card data-ui="tool-loop-request-surface" className="rounded-panel shadow-none">
      ...
      <CardContent className="px-6 pb-6 pt-6 sm:px-7 sm:pb-7">
        <form key={demoMode ?? "blank"} onSubmit={onSubmit} className="space-y-7">
          {demoMode === "tool-loop" ? <p aria-live="polite" className="rounded-control border border-brand-purple/20 bg-brand-purple/10 px-3 py-2 text-sm font-medium text-secondary-foreground">Demo values loaded. Review before checking.</p> : null}
          <div className="grid gap-5 sm:grid-cols-2">
            <label className="block space-y-2">
              ...
              <input
                ...
                className="min-h-11 w-full rounded-control border border-border bg-background px-3 text-sm outline-none transition-colors placeholder:text-muted-foreground focus-visible:border-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
              />
            </label>
            <label className="block space-y-2">
            ...
            <label className="block space-y-2 sm:col-span-2">
              ...
              <textarea
                ...
                className="min-h-28 w-full resize-y rounded-control border border-border bg-background px-3 py-2 text-sm leading-6 outline-none transition-colors placeholder:text-muted-foreground focus-visible:border-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
              />
            </label>
          </div>
