...
const steps = [
  { href: "/", title: "Product overview", observation: "Read the product overview and continue to Explore." },
  {
    ...
    observation: "Find the RiskScan entry and its local discovery surface."
  },
  {
    href: "/explore/riskscan",
    title: "Read RiskScan",
    observation: "Review the Quick input, result, and configuration boundaries."
  },
  {
    href: "/explore/riskscan/try",
    title: "Try the local request",
  ...
  { href: "/dashboard", title: "Open the workspace", observation: "See the guest workspace shell." },
  {
    ...
    observation: "Follow the guest RiskScan workbench sequence."
  },
  {
    href: "/dashboard/riskscan/compatibility",
    title: "Check compatibility",
    observation: "Inspect the guest native quote compatibility surface."
  },
  {
    href: "/dashboard/riskscan/preflight",
    title: "Review disclosures",
    observation: "Inspect the guest Quick disclosure preflight."
  },
] as const;
      ...
      {steps.map((step, index) => (
        <li key={step.href}>
          <Card className="h-full">
            ...
            <CardContent>
              <Link href={step.href} className="text-sm font-medium text-primary underline-offset-4 hover:underline">
                Open this screen
              </Link>
            </CardContent>
          </Card>
