...
export function WorkspaceOverview() {
  return (
    <section className="grid gap-4 sm:grid-cols-3" aria-label="Workspace orientation">
      <Card className="rounded-2xl border-border bg-card shadow-none">
        <CardContent className="flex min-h-24 flex-col justify-center gap-1 p-5">
          ...
          <span className="text-lg font-bold tracking-[-0.025em] text-foreground">Guest workspace</span>
        </CardContent>
      </Card>
      <Card className="rounded-2xl border-border bg-card shadow-none">
        <CardContent className="flex min-h-24 flex-col justify-center gap-1 p-5">
