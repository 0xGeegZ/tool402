          ...
          <div className="space-y-5">
            ...
            <CardContent className="space-y-5 p-0">
              ...
              <div className="flex flex-wrap gap-3">
                <Link
                  href="/"
                  className="inline-flex min-h-10 items-center rounded-[var(--radius)] bg-primary px-4 text-sm font-medium text-primary-foreground transition-colors hover:bg-brand-purple"
                >
                  Return home
                </Link>
                <Link
                  href="/explore"
                  className="inline-flex min-h-10 items-center rounded-[var(--radius)] border border-border px-4 text-sm font-medium transition-colors hover:bg-muted"
                >
                  Explore tools
                </Link>
              </div>
