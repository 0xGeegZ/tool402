        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-5 lg:gap-12">
          ...
          <nav aria-label="Documentation links">
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/docs/api" className="transition-colors hover:text-foreground">API reference</Link></li>
              <li><Link href="/docs/faq" className="transition-colors hover:text-foreground">FAQ</Link></li>
            </ul>
          </nav>
