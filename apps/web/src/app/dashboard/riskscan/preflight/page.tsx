  ...
  return (
    <main className="pb-6 sm:pb-12">
      <article className="mx-auto max-w-3xl space-y-8">
        <PageHeader title="RiskScan Quick preflight" description="Review caller-reported disclosures in this guest local preflight before the unsigned request boundary." />
