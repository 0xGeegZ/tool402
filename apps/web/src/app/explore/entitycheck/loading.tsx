...
export default function Loading() {
  return (
    <main className="mx-auto max-w-3xl space-y-8 pb-6 sm:pb-12">
      ...
      <div data-skeleton-region="capability" className="h-24 w-full max-w-3xl">
        <Skeleton />
      </div>
      <div data-skeleton-region="inputs" className="h-72 w-full max-w-3xl">
        <Skeleton />
      </div>
      <div
      ...
      <div data-skeleton-region="sources" className="h-48 w-full max-w-3xl">
        <Skeleton />
      </div>
      <div
