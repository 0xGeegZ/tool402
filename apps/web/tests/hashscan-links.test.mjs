...
test("makes testnet HashScan links only for exact canonical identifiers", async () => {
  ...
  const paddedSettlement = "0.0.1002@1720000000.000000001";
  ...
  assert.equal(hashscanTransactionUrl(paddedSettlement), "https://hashscan.io/testnet/transaction/0.0.1002-1720000000-000000001");
  assert.equal(hashscanContractUrl(address), "https://hashscan.io/testnet/contract/" + address);
  for (const value of [undefined, "", "0xABC", "0x" + "AB".repeat(32), "0.0.01@1.2", "0.0.1@01.2", "0.0.1@1.0000000000", "0.0.1@1.1234567890", "javascript:alert(1)", "https://example.test"]) {
