# B02 implementation plan — RiskScan route settlement evidence

Execution plan for [B02-T010](../../work-queue/queue/60-done/B02-T010-riskscan-route-settlement-evidence.md)
against the [B02 route settlement-evidence contract](../../specs/b02-riskscan-route-settlement-evidence.md).
