...
- CURRENT_TASK: M03-T020 (20-active)
- ACTIVE_LANES: M03-T020 Task 1 core payment-state provenance hardening
...
- NEXT_ELIGIBLE_TASKS: M03-T020 is active. The root dispatches its one sequential core provenance-hardening task; external settlement mapping, API/UI work, and live evidence remain separate local work.
