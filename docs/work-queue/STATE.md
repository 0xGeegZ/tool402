...
- NEXT_ELIGIBLE_TASKS: M03-T020 is 10-ready. The root may activate its one sequential core provenance-hardening task; external settlement mapping, API/UI work, and live evidence remain separate local work.
