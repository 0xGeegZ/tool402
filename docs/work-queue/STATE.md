...
- CURRENT_MODULE: M14 guest RiskScan workbench ready
- CURRENT_TASK: M14-T010 (10-ready)
- ACTIVE_LANES: none
...
- LOCAL_UI_RECORDS: docs/ui/UI-S00.md, docs/ui/UI-S01.md, docs/ui/UI-S02.md, docs/ui/UI-S03.md, docs/ui/UI-S04.md, docs/ui/UI-S05.md, docs/ui/UI-S06.md, docs/ui/UI-S07.md, docs/ui/UI-S08.md, docs/ui/UI-S09.md, docs/ui/IMPORT-LEDGER.md
...
- NEXT_ELIGIBLE_TASKS: M14-T010 is ready for its focused local RED/GREEN workbench contract. Do not reopen M04 persistence or reconciliation. A payment client or live path remains blocked while HA-X402-HEDERA-001 is PENDING.
