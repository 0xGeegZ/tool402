...
- CURRENT_TASK: M03-T010 (00-inbox)
- ACTIVE_LANES: none
...
- NEXT_ELIGIBLE_TASKS: M03-T010 is recorded in 00-inbox. The root must validate its accepted dependency, disjoint ownership, committed local specification/plan, human-action boundary, and concrete validation before it may move to 10-ready.
