...
| M01-T011 | M01 foundation | CORE_P0 | 10-ready | docs/work-queue/queue/10-ready/M01-T011-node-runtime-selection.md | M01-T010 accepted | Card, docs/specs/m01-node-runtime-selection.md, docs/superpowers/plans/2026-09-04-m01-node-runtime-selection.md, .nvmrc, README.md, and root-integrator queue records | none | Version-selector RED/GREEN smoke, Node 22/npm 10 verification, queue check, and independent review. |
