...
| M01-T090 | M01 foundation | CORE_P0 | 00-inbox | docs/work-queue/queue/00-inbox/M01-T090-queue-check-validator.md | M01-T010 accepted | Card and root-integrator queue records | none | Minimum local validation specification, RED executable contract, targeted validator tests, queue command, and independent review. |
