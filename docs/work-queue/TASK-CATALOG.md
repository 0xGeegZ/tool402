...
| M01-T090 | M01 foundation | CORE_P0 | 10-ready | docs/work-queue/queue/10-ready/M01-T090-queue-check-validator.md | M01-T010 accepted | Card, docs/specs/m01-queue-check.md, docs/superpowers/plans/2026-09-04-m01-queue-check.md, and root-integrator queue records | none | Committed local validation specification, RED executable contract, targeted positive/negative tests, queue command, and independent review. |
