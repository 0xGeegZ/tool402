...
| M01-T010 | M01 foundation | CORE_P0 | 20-active | docs/work-queue/queue/20-active/M01-T010-root-workspace.md | P00-T010 accepted | Card, docs/specs/m01-root-workspace.md, docs/superpowers/plans/2026-09-04-m01-root-workspace.md, and root-integrator queue records | none | Committed local foundation specification, RED/GREEN scaffold smoke, targeted workspace validation, and independent review. |
