...
| P00-T010 | Product brief | CORE_P0 | 00-inbox | docs/work-queue/queue/00-inbox/P00-T010-product-overview.md | M00-T080 accepted | Card, STATE.md, TASK-CATALOG.md, FILE-OWNERSHIP.md, AI_USAGE.md | none | Local brief content, local-reference boundary, and independent review. |
