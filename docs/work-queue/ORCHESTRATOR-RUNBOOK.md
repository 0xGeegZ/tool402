...
This clean repository is the sole implementation and runtime-queue authority. The root alone mutates queue state, STATE.md, decisions, human-action/evidence ledgers, and shared generated files/lockfiles.
...
Pause only for a recorded human action, destructive operation, unresolved core decision, mandatory sponsor-gate failure, record-integrity/security risk, or no eligible work. Resume from this repository Git state and STATE.md, not a chat transcript.
