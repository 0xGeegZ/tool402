...
- M02-T020 and S17-T010 are accepted. UI-S29, the S29 card, ledger, catalog,
...
- `layout.tsx` and `local-navigation.tsx` have no active source owner. The
  only test overlap was resolved by D-S29-010-002: S29 may amend exactly the
...
- The focused baseline is 14 passing tests and one failure only: the obsolete
  five-link Guided Demo navigation assertion. It is inside S29's reservation.
