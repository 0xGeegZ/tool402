...
M37-T010 is a root-owned resumption-ready record comprising its card,
...
Its historical test-only RED may be restored only after the fresh
ready-state rescan and activation required by D-HI-001-005. It remains private,
source-only, and unavailable to every runtime or external path.
