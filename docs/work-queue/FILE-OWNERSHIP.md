...
M00-T070 reserves its card, qualification matrix, HUMAN-ACTIONS.md, and DECISIONS.md to the root integrator. M00-T080 declares its card, STATE.md, FILE-OWNERSHIP.md, TASK-CATALOG.md, DECISIONS.md, and HUMAN-ACTIONS.md as root-only paths when it becomes active.
