...
- This card, UI-S19, catalog, ledger, ownership, decision, and state records
  are committed before a RED test, package, or source change.
...
- An independent review finds no Critical, Important, or Minor issue before
  this card enters 10-ready.
