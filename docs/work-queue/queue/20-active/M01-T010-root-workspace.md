...
2. The root boundary declares exactly apps/* and packages/*, requires Node 22/npm 10, and exposes typecheck, lint, test, build, and queue-validation command entry points. Quality commands no-op only while both workspace roots are absent.
