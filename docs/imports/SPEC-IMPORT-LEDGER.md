...
| `docs/specs/m30-riskscan-route-settlement-evidence.md` | Runtime-local | One server-owned consumer seam and bounded in-process sink that make the accepted M03 settlement observer reachable from the protected route | Local implementation accepted |
