...
| `docs/specs/m12-riskscan-native-quote-eligibility.md` | Runtime-local | Caller-defined native quote compatibility using accepted local value and native-summary boundaries | Contract reviewed and ready for local implementation |
