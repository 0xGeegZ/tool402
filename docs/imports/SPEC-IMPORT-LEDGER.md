...
| `docs/specs/m21-clearing-split-lifecycle.md` | PREP-SPECS-001 | Issued-result-bound pure clearing-split recovery lifecycle with no allocation, durable attempt, or external action | Contract active for local implementation |
