...
| `docs/specs/m18-offering-purchase-lifecycle.md` | PREP-SPECS-001 | Requirements-bound pure purchase workflow adapted to the accepted local terms and canonical quote boundaries | Contract recorded for independent readiness review |
