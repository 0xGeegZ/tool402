...
| `docs/specs/m20-offering-definition-schema.md` | PREP-SPECS-001 | Closed descriptor-safe offering-definition ingress that binds declared maturity and opaque resource metadata to accepted local economics terms | Contract active for local implementation |
