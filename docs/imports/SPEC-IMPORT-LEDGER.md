...
| `docs/specs/m28-agent-directory-record-candidate-schema.md` | PREP-SPECS-001 | Narrow closed Directory-record candidate parser for untrusted advertised metadata; receipt candidates, invariant generators, publication, and payment authority remain separate | Contract reviewed and ready for local implementation |
