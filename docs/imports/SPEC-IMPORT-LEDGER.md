...
| `docs/specs/m30-authenticated-external-prepare-normalizer.md` | Runtime-local | Human-approved secret-free EIP-712 command authority narrowed to claimed-body normalization, M26 payload binding, injected signer authority, and no durable or external behavior | Contract intake and independent design review required before RED |
