...
| `docs/specs/m25-claimed-protected-body.md` | PREP-SPECS-001 | Private raw-byte binding across accepted cryptographic ingress verification and replay-claim handoff, before any command parsing | Contract reviewed and ready for local implementation |
