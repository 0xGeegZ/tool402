...
| `docs/specs/m12-tool-loop-agent-native-quote-evaluation.md` | Runtime-local | One required-injected Agent directory composition into accepted local native quote compatibility | Contract amended for fresh readiness review |
