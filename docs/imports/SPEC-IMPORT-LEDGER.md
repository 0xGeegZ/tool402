...
| `docs/specs/m26-external-prepare-payload.md` | PREP-SPECS-001 | Closed external-prepare payload vocabulary for later authenticated-command and durable-attempt boundaries, adapted to the local pure Core package | Contract intake and independent design review required before RED |
