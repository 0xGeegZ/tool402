...
| `docs/specs/m19-paid-task-lifecycle.md` | PREP-SPECS-001 | Task-local canonical requirements binding, explicit expiry, and closed paid-task outcome states adapted to the accepted pure Core boundary | Contract recorded for independent design review |
