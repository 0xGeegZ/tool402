...
| `docs/specs/m22-ingress-envelope.md` | PREP-SPECS-001 | Closed descriptor-safe ingress envelope, fixed canonical signing input, and correlation-only replay identity with no HMAC, key, clock, or persistence behavior | Contract intake and independent design review required before RED |
