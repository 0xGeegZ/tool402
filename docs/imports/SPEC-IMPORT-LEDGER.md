...
| `docs/specs/m16-offering-terms-and-revenue-math.md` | PREP-SPECS-001 | Versioned offering terms, exact unit allocation, capped 80/20 clearing math, and explicit maturity input adapted to the local pure Core boundary | Contract and inbox card recorded; implementation not started |
