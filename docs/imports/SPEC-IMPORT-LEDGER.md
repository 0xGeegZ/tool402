...
| `docs/specs/m29-shell-accessibility-amendment.md` | PREP-SPECS-001 | Reduced-motion, focus, landmark, and non-overflow shell constraints adapted as a narrow local UI-S00 amendment | Authority reviewed and ready for local RED/GREEN |
